...
public class ServerFrame extends JFrame implements ActionListener
{
	...
	ServerFrame()
	{
		...
		audioPanel.setPreferredSize(new Dimension((int)(width*0.89),(int)(height*0.4)));//------ajay
		audioPanel.add(new JScrollPane(studentPanel),BorderLayout.CENTER);
		audioPanel.setBackground(Color.white);
		//audioPanel.setBorder(new CompoundBorder(new LineBorder(Color.GREEN, 10), new EmptyBorder(5, 5, 5, 5)));
		...
		///////////////////////////////////////
		setSize((int)(width),(int)(height)); //setting the size of frame --------------------- ajay
		...
		JPanel midPanel = new JPanel(new BorderLayout()); // middle panel holding tabbed pane -------------ajay
		...
		*/
		...
		JScrollPane scrollPane = new JScrollPane(audioPanel); // ajay
        scrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        scrollPane.setWheelScrollingEnabled(true);
        scrollPane.setPreferredSize(new Dimension((int)(width*0.9),(int)(height*0.75)));
        scrollPane.setBorder(new CompoundBorder(new LineBorder(Color.YELLOW, 2), new EmptyBorder(5, 5, 5, 5)));
		...
		tabbedPane.addTab("Audio",scrollPane); // ajay
		tabbedPane.addTab("Text",textPanel);
		tabbedPane.setBackground(Color.BLUE);
		
		topPanel.setBorder(new CompoundBorder(new LineBorder(Color.BLACK, 2), new EmptyBorder(2, 2, 2, 2)));
		midPanel.setBorder(new CompoundBorder(new LineBorder(Color.RED, 2), new EmptyBorder(2, 2, 2, 2)));
		bottomPanel.setBorder(new CompoundBorder(new LineBorder(Color.GREEN, 2), new EmptyBorder(2, 2, 2, 2)));
		
		
		midPanel.add(tabbedPane,BorderLayout.CENTER); // ajay
		
		parentPanel.add(topPanel,BorderLayout.NORTH);
		parentPanel.add(midPanel,BorderLayout.CENTER); // change from tabbedpane to midPanel
	...
	private JPanel createStudentPanel(int i,Student student)
	{
		...
		*/
		...
		finalPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 2, 2));
		finalPanel.setPreferredSize(new Dimension((int)(width*0.9),(int)(height*0.1)));
		
		int studentPanelHeight=(int)(height*0.09);
		...
		imagePanel.setBorder(new CompoundBorder(new LineBorder(Color.magenta, 1), new EmptyBorder(0, 0, 0, 0)));
		...
		namePanel.setBorder(new CompoundBorder(new LineBorder(Color.magenta, 1), new EmptyBorder(0, 0, 0, 0)));
		...
		doubtPanel.setBorder(new CompoundBorder(new LineBorder(Color.magenta, 1), new EmptyBorder(0, 0, 0, 0)));
		
		JPanel addButtonPanel=new JPanel();
		addButtonPanel.setPreferredSize(new Dimension((int)(width*0.05),studentPanelHeight));
		addButtonPanel.add(addButton.get(i));
		addButtonPanel.setBorder(new CompoundBorder(new LineBorder(Color.magenta, 1), new EmptyBorder(0, 0, 0, 0)));
		...
		deleteButtonPanel.setBorder(new CompoundBorder(new LineBorder(Color.magenta, 1), new EmptyBorder(0, 0, 0, 0)));
		...
		finalPanel.setBorder(new CompoundBorder(new LineBorder(Color.BLACK, 1), new EmptyBorder(1, 1, 1, 1)));
		return finalPanel;
	}
